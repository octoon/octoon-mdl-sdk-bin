...
public:
    ...
    ///
    /// - \c "enable_df_interpreter": Enables/disables code and data generation for the interpreter,
    ///   if possible. For too complex materials it may fall back to full code generation.
    ///   Possible values:
