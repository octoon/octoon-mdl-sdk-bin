...
#if defined(MDL_SOURCE_RELEASE) || defined(MDL_BINARY_RELEASE)
    #include <example_shared.h>
#else // MDL_SOURCE_RELEASE || MDL_BINARY_RELEASE
    #include <prod/mdl_examples/mdl_sdk/shared/example_shared.h>
#endif // MDL_SOURCE_RELEASE || MDL_BINARY_RELEASE
