...
function(FIND_D3D12_EXT)
    ...
    # WINRT Headers
    find_file(_WRL_H "wrl.h"
        HINTS
            ${CMAKE_WINDOWS_KITS_10_DIR}/Include/${_SDK_VERSION_STRING}/winrt
        )
    get_filename_component(_WINRT_INCLUDE_DIR "${_WRL_H}" DIRECTORY)

    if(NOT EXISTS ${_D3D12_INCLUDE_DIR} OR NOT EXISTS ${_DXGI_INCLUDE_DIR} OR NOT EXISTS ${_WINRT_INCLUDE_DIR} )
